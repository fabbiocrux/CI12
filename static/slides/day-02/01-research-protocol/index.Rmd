...
figs <- here("static", "slides", "figures/")
...
include_graphics(path = "../thumb.jpeg")
```
]
...
2. Understand the purpose of the research protocol concept


---

## Remember the Mental model of the research process


```{r, out.width='80%'}
include_graphics(paste0(figs, 'Research-conceptualization-00.jpg'))
```
...
## From the Research question to the Experimental Protocol
