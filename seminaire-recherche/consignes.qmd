  ...
  pdf:
    ...
    include-in-header:    
      - text: |
          ...
          \fancyfoot[L]{Document rédigé par Fabio CRUZ. Version \today}
          \fancyfoot[C]{\thepage}
          \fancyfoot[R]{ENSGSI}
...
Voir @fig-passage. En cas changement, le document sera mise à jour.  

:::{#fig-passage layout="[100]"}

![Jeudi 21/05/26.](Jeudi.png){width="80%" fig-align="center"}

![Vendredi 22/05/26.](Vendredi.png){width="80%" fig-align="center"}
