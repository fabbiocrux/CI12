...
subtitle: "Module CI12: Recherche Developpement et Innovation \\newline UE 1053: Paradigme et Méthodologie de Recherche en Innovation"
  ...
  pdf:
    ...
    include-in-header:    
      - text: |
          ...
          \fancyhead[C]{Recherche, Innovation et Développement}
          \fancyhead[L]{\includegraphics[width=2cm]{../assets/img/ENSGSI.png}}          
          \fancyfoot[L]{\footnotesize Document rédigé par Fabio CRUZ. Version \today}
          \fancyfoot[C]{\thepage}
          \fancyfoot[R]{ENSGSI}
...
Comme nous l’avons souligné, l’objectif pédagogique du module est de vous donner des outils de recherche et de veille stratégique dans les travaux scientifiques qui puissent être pertinents pour votre avenir professionnel, aussi bien pendant votre stage qu’au-delà.

Comme discuté lors des séances de cours, la recherche scientifique constitue une démarche supplémentaire pour renforcer votre légitimité et
votre expertise sur un sujet donné.
L'une des caractéristiques de la formation à l’ENSGSI est de vous préparer à intervenir dans différents domaines : conception de produit/service, gestion de projet en milieu complexe, innovation territoriale, entre autres.
...
1. *Formulaire*: 
   - Vous trouverez ci-dessous le lien vers le questionnaire à compléter : [https://forms.gle/kpFPZJxHPC5AvvR1A](https://forms.gle/kpFPZJxHPC5AvvR1A)  ![Questionnaire à remplir une fois lecture de l'article](questionnaire.png){ width="100px" fig-align="center"}


1. **Horaire et ordre de passage** 
Voir figures ci-dessous. En cas changement, le document sera mise à jour.  


![Jeudi A 21/05/26.](Jeudi-A.png){width="500px" fig-align="center"}

![Jeudi B 21/05/26.](Jeudi-B.png){width="500px" fig-align="center"}

![Vendredi A 22/05/26.](Vendredi-A.png){width="500px" fig-align="center"}

![Vendredi B 22/05/26.](Vendredi-B.png){width="500px" fig-align="center"}
...
- Jeudi A: [https://events.teams.microsoft.com/event/5bdcb79f-a161-41ec-ab6b-a87d1c30012e@158716cf-46b9-48ca-8c49-c7bb67e575f3](https://events.teams.microsoft.com/event/5bdcb79f-a161-41ec-ab6b-a87d1c30012e@158716cf-46b9-48ca-8c49-c7bb67e575f3)

- Jeudi B: [https://events.teams.microsoft.com/event/90ffb2d1-8691-49b6-9819-7b43959b957c@158716cf-46b9-48ca-8c49-c7bb67e575f3](https://events.teams.microsoft.com/event/90ffb2d1-8691-49b6-9819-7b43959b957c@158716cf-46b9-48ca-8c49-c7bb67e575f3)

- Vendredi A: [https://events.teams.microsoft.com/event/1808e505-677b-4874-987e-e05d185771a9@158716cf-46b9-48ca-8c49-c7bb67e575f3](https://events.teams.microsoft.com/event/1808e505-677b-4874-987e-e05d185771a9@158716cf-46b9-48ca-8c49-c7bb67e575f3)

- Vendredi B: [https://events.teams.microsoft.com/event/f23718d9-187e-4b00-9960-ff9ba31345f3@158716cf-46b9-48ca-8c49-c7bb67e575f3](https://events.teams.microsoft.com/event/f23718d9-187e-4b00-9960-ff9ba31345f3@158716cf-46b9-48ca-8c49-c7bb67e575f3)
...
1. **Déroulé du séminaire**:

   1. *Présentation du travail*: Le.la présentateur.trice réalise sa présentation dans le temps imparti. 
   2. *Intervention des évaluateur.trices*: Chaque évaluateur.trice formule :
         a. Une appréciation générale de la présentation et du document lu ;
         b. La question ou remarque qu’il.elle considère la plus pertinente pour enrichir la discussion.
   3. *Retour du jury*: Un/les membre(s) du jury partage ensuite son retour global, ses observations et ses pistes de réflexion sur l’ensemble des échanges.
 

1. **Support PPT/PDF**: Vous pouvez déposer votre support de présentation sur ARCHE gagner du temps lors de la présentation.
...
1. ***Soyez bienveillant.e.s les un.e.s envers les autres..***
...
2. ***Que votre parole soit constructive.***
